...
function bookmark(e,t){var r=window.location.pathname;if(t+=r.substring(r.lastIndexOf("/")+1),window.sidebar)browser.bookmarks.create({title:e,url:t});else if(window.opera&&window.print){var a=document.createElement("a");a.setAttribute("href",t),a.setAttribute("title",e),a.setAttribute("rel","sidebar"),a.click()}else document.all&&window.external.AddFavorite(t,e)}